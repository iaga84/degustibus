...
class Book(BaseModel):
    ...
    genre = models.ForeignKey(Genre, on_delete=models.SET_NULL, related_name='genre_books', null=True, blank=True, db_constraint=False)
    sub_genre = models.ForeignKey(Genre, on_delete=models.SET_NULL, related_name='sub_genre_books', null=True, blank=True)
